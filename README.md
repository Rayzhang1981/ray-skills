...
## Skills on the marketplace (SkillHub · 22)
...
|-------|---------|-----------|:---:|----------|
| ray-excel-html | 2.6.0 | Convert Excel/engineering calc sheets to standalone offline HTML tools | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-excel-html) |
...
| ray-ps-inforgraphic | 2.3.0 | Chemical safety infographic generator | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-ps-inforgraphic) |
...
| ray-file-distil | 1.16.0 | Distill books/long documents into atomic reusable skills | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-file-distil) |
...
| ray-ppt-generator | 3.20.0 | Generate editable PPTX decks with python-pptx | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-ppt-generator) |
| ray-ppt-refine | 2.5.1 | PPTX layout beautification & compliance gate (edit-only, no content change) | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-ppt-refine) |
| ray-ppt-video | 2.7.1 | Turn training PPTX into narrated MP4 videos (TTS + hard subtitles) | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-ppt-video) |
| ray-deep-research | 1.4.1 | Deep research on a target via source-tracing & horizontal comparison | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-deep-research) |
| ray-synth-search | 1.8.0 | Daily multi-source search with cross-validation & confidence scoring | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-synth-search) |
| ray-standard-search | 3.0.2 | Chemical/process standards & regulations quick search (IMA optional) | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-standard-search) |
...
| ray-pse-video | 2.4.1 | Incident report → narrated safety training video | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-pse-video) |
| ray-self-reflection | 3.18.0 | Self-reflection & experience distillation for AI agents | ✅ | [Install](https://skillhub.cn/skills/user_fb8bdb79/ray-self-reflection) |
